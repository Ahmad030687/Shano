...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "funny") || (event.body.toLowerCase() == "songs")) {
    ...
    if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😱")) {
       return api.sendMessage("is nazar se serf  𝐀𝐇𝐌𝐀𝐃  dekh sak thi hai Mujhe💞", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "Ahmad" (event.body.toLowerCase() == "Ahmii")) {
       return api.sendMessage("Boss busy hai Mujse bat Karo 🙄", threadID);
     };
   if ((event.body.toLowerCase() == "janu") || (event.body.toLowerCase() == "jan")) {
      return api.sendMessage("Janu me serf AHMAD ki hu samjhy", threadID);
     };
   if ((event.body.toLowerCase() == "😂😂😂") || (event.body.toLowerCase() == "😁😁😁")) {
   ...
   if ((event.body.toLowerCase() == "🙏") || (event.body.toLowerCase() == "🙏🙏")) {
    ...
    if ((event.body.toLowerCase() == "ashii") || (event.body.toLowerCase() == "ayehsa")) {
       ...
       if ((event.body.toLowerCase() == "Ahmad Kon ho ap") || (event.body.toLowerCase() == "AHMAD ap kon ho")) {
     ...
     if ((event.body.toLowerCase() == "inbox aa")) {return api.sendMessage("kab Sai Hoga ye system Har koi inbox 📥 Jana chata 😀🙄🙄 ", threadID);
      ...
      if ((event.body.toLowerCase() == "ladki ho")) {return api.sendMessage("Nahi ye both Hai tharki insan 😂😀🙄 ", threadID);
              ...
              if ((event.body.toLowerCase() == "wow")) {return api.sendMessage("Thank you Apko bhi bot chahiya tOo AHMAD se rabta karo👍👍💕" , threadID);
     };
  ...
  if ((event.body.toLowerCase() == "👌")) {return api.sendMessage("𝑻𝒖𝒔𝒊 𝒂𝒘𝒔𝒐𝒎𝒆 𝒉𝒐 𝒈👌👌 ", threadID);
    ...
    if ((event.body.toLowerCase() == "🤤")) {return api.sendMessage("Mho se supari nikal rey baba 🤣🤣", threadID);
     ...
     if ((event.body.toLowerCase() == "logos") || (event.body.toLowerCase() == "logo")) {
       return api.sendMessage("Logos ! 🥀 GALAXY, CAKE, CRACK, GLITCH, CLOUD, DRAGON, FROZEN, BUSINESS, ANIMATE, LOGODIAMOND, LOGOCAPTAIN, LOGOFISH, LOGOCOLORBLUR, LOGOBLOODTEXT, LOGOWOOD, LOGOCUP          🥀for example -> +crack AHMAD Khan", threadID);
     };
  ...
  ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "good morning")) {
    ...
    if ((event.body.toLowerCase() == "meri setting kahan hai") || (event.body.toLowerCase() == "meri gf kaha hai")) {     return api.sendMessage("️️️mujhy nahi pata me 𝐀𝐇𝐌𝐀𝐃 ki setting hu", threadID);
     };
     ...
     if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "bot ka malik")) {
       return api.sendMessage("༻𝐎𝐖𝐍𝐄𝐑:- ☞ ༻☞[𝐎𝐖𝐍𝐄𝐑:☞➸⃝🐼𝑨𝑯𝑴𝑨𝑫 𝑹𝑫𝑿🎸  ☜ 𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝐀𝐇𝐌𝐀𝐃. ☜ ༺༒ ༒𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝༒:- https://www.facebook.com/profile.php?id=61577631137537 ☞    his insta id @ahmadalisafdar714 ☜ ༺༒ ༒", threadID);
     };

     if ((event.body.toLowerCase() == "tera Malik kon hai") || (event.body.toLowerCase() == "is bot ka malik kon hai")) {
       return api.sendMessage("𝐀𝐇𝐌𝐀𝐃 𝐑𝐃𝐗 𝐔𝐫𝐟 𝐀𝐇𝐌𝐀𝐃   ❤️ My Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Latkaye Mat Rakkha Karo. Har Waqt Haste Raho.", threadID);
     };

    if ((event.body.toLowerCase() == "tera admin kon hai") || (event.body.toLowerCase() == "bot ka admin kon hai")) {
       return api.sendMessage("My admin is 𝑨𝑯𝑴𝑨𝑫 𝑹𝑫𝑿. He Gives his name mr 𝐀𝐇𝐌𝐀𝐃 everywhare", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "by") || (event.body.toLowerCase() == "bye")) {;
     ...
     if ((event.body.toLowerCase() == "chup") || (event.body.toLowerCase() == "stop") || (event.body.toLowerCase() == "chup ho ja") || (event.body.toLowerCase() == "chup kar")) {
       return api.sendMessage("Nhi rahungi 😼 Mujhe Bolna H. Tumhe Koi Haq nhi Mujhe Chup Karane ka. Mera Zuban. M Bolungi AHMAD ko baton kya🙄🙄", threadID);
     };
    if ((event.body.toLowerCase() == "bts") || (event.body.toLowerCase() == "btc")) {
     ...
     if ((event.body.toLowerCase() == "malik se bakchodi") || (event.body.toLowerCase() == "malik se backchodi") || (event.body.toLowerCase() == "malkin se bakchodi") || (event.body.toLowerCase() == "malkin se backchodi")) {
       return api.sendMessage("sorry malik maaf kr do ab nhi krugi AHMAD please maaf karo na🥺🙏", threadID);
     };
     ...
     if ((event.body.toLowerCase() == "bot kiss me") || (event.body.toLowerCase() == "kiss me")) {
       return api.sendMessage("️Kis khushi me, Me sirf Apne Boss AHMAD ko kiss karna chahti hu", threadID);
     };
     ...
     if ((event.body.toLowerCase() == "😡") || (event.body.toLowerCase() == "👿") || (event.body.toLowerCase() == "😠") || (event.body.toLowerCase() == "👿") || (event.body.toLowerCase() == "😈")) {
       return api.sendMessage("️🥺 Me toh Sirf Mazak Kr Rhi Thi, Chalo Ek chappal khao 🩴🩴🩴 aur AHMADt rho 😘", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "love you")) {     return api.sendMessage("️️️ITNE MUJHE I LOVE YOU BOL RHI HO MERE BOSS AHMAD KHAN URF SALAAR KO BOLO BAHUT HI ACHA BNDA HAI MERA BOSS ", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "🙄")) {return api.sendMessage(" AHMAD Boss busy hai mujse bat karo🙄🙄 ", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "😜😜")) {return api.sendMessage("Ghndy ishary na kro me AHMAD ko bata dongi 🥺 ", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "😍😍")) {return api.sendMessage("IS NAZAR SE AHMAD KHAN KO DEKHO PYARA NA LAGY PAISE WAPIS 😝😂 ", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "😍")) {return api.sendMessage("IS NAZAR SE MERE OWNER AHMAD KO DEKHO MAZA NA AY TO PAISE WAPIS 😝😂 ", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "🤐")) {
    ...
    if ((event.body.toLowerCase() == "AHMAD") || (event.body.toLowerCase() == "AHMAD") || (event.body.toLowerCase() == "main romiyo") || (event.body.toLowerCase() == "main saho") || (event.body.toLowerCase() == "main rounak")) {
